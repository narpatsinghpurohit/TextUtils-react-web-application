# Text Utility react web application 
This is a simple react application which is used to do the following:
1. Change any text to Upper case
2. Change any text to Lower case
3. Change any text to Camel case
